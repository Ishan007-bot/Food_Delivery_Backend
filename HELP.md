...
* The original package name 'com.backend.fooddelivery.food-delivery-service' is invalid and this project uses 'com.backend.fooddelivery.food_delivery_service' instead.
